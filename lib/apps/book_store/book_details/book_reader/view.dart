                        ...
                        builder:
                          ...
                          return ListView(
                            ...
                            child: Html(
                              ...
                              customRender: {
                                "u": (RenderContext context, Widget child) {

                                  return Text('${context.tree.element?.text}',style:
                                  TextStyle(color: Colors.black,decoration: TextDecoration.lineThrough,backgroundColor: Colors.blue),);
                                },
                              },
                            ),
                            // child: CustomSelectableText.rich(
                            //   TextSpan(
                            //       text: parse(data).body?.text??'aas', style: Get.textTheme.bodySmall),
