                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: DropShadowImage(
                        ...
                        blurRadius: 5,
                        borderRadius: 3,
                        image: BookCover(title: "${logic.book.value.name}",
                              ...
                              child: Column(
                                children: [
                                  Padding(
                                    ...
                                    child: Row(
                                      children: [
                                        mue('目录', '${logic.book.value.catalogueNum}', '章节'),
                                        const SizedBox(
                                          width: 16,
                                        ),
                                        mue('全文', '${logic.book.value.sizeNum ?? 0}', '字'),
                                      ],
                                    ),
                                  ),
                                  Expanded(
                                          ...
                                          child: SizedBox(
                                            ...
                                            child: OutlinedButton.icon(
                                                onPressed: () {
                                                  ...
                                                  tts.showSpeak(logic.book.value,context: context);
                                              ...
                                              child: ElevatedButton(
                                                  onPressed: () {
                                                    Get.toNamed(
                                                        ...
                                                        parameters: {
                                                          'bookId':'${logic.book.value.bookId}',
                                                          'title':'${logic.book.value.name}',
                                                          'author':'${logic.book.value.author}',
                                                          'isJoin':'${logic.book.value.isJoin}',
                                                          'index':'0',
                                                    });
                                                  },
                                                  child: Text('阅读全文')),
