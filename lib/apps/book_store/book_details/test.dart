...
import 'package:text_composition/text_composition_page.dart';
...
class _TestState extends State<Test> {
  ...
  List<List<String>>  getText({required String text, required double fontSize,
    ...
    print("用时：${n2.difference(n1).inMilliseconds}ms");
    return pages;
  }
...
　子曰：“《诗》三百，一言以蔽之，曰：‘思无邪’。”\n
  ...
  @override
  void initState() {
  document=  html.parse(data);
    super.initState();
  textComposition = TextComposition(config: TextCompositionConfig(
      fontSize: 16,
        ...
        child: SizedBox(
          child:  LayoutBuilder(
            builder: (BuildContext context, BoxConstraints constraints) {
              ...
              return TextCompositionPage(controller: textComposition,);
            },
