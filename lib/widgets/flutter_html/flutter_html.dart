...
import 'package:huaxia/widgets/flutter_html/html_parser.dart';
import 'package:huaxia/widgets/flutter_html/image_render.dart';
import 'package:huaxia/widgets/flutter_html/src/html_elements.dart';
import 'package:huaxia/widgets/flutter_html/style.dart';
import 'package:html/dom.dart' as dom;
import 'package:huaxia/widgets/flutter_html/src/navigation_delegate.dart';

import '../custom_selectable_text/custom_selectable_text.dart';


//export render context api
export 'package:huaxia/widgets/flutter_html/html_parser.dart';
export 'package:huaxia/widgets/flutter_html/image_render.dart';
//export src for advanced custom render uses (e.g. casting context.tree)
export 'package:huaxia/widgets/flutter_html/src/anchor.dart';
export 'package:huaxia/widgets/flutter_html/src/interactable_element.dart';
export 'package:huaxia/widgets/flutter_html/src/layout_element.dart';
export 'package:huaxia/widgets/flutter_html/src/replaced_element.dart';
export 'package:huaxia/widgets/flutter_html/src/styled_element.dart';
export 'package:huaxia/widgets/flutter_html/src/navigation_delegate.dart';
//export style api
export 'package:huaxia/widgets/flutter_html/style.dart';
...
class SelectableHtml extends StatefulWidget {
  ...
  SelectableHtml({
    ...
    this.scrollPhysics, required this.items, required this.onSingleTapUp, required this.onSelectionChanged,
     this.customRender=const {},
  }) : document = null,
        assert(data != null),
        _anchorKey = anchorKey ?? GlobalKey(),
...
class _SelectableHtmlState extends State<SelectableHtml> {
  ...
  void didUpdateWidget(SelectableHtml oldWidget) {
    if (widget.data!=null&& !identical(oldWidget.data,widget.data)){
      doc = HtmlParser.parseHTML(widget.data!);
      setState(() {});
    }
    if (widget.document!=null&& !identical(oldWidget.document,widget.document)){
      doc = widget.document!;
      setState(() {
  ...
  @override
  void initState() {
    doc = widget.data != null ? HtmlParser.parseHTML(widget.data!) : widget.document!;
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    final double? width = widget.shrinkWrap ? null : MediaQuery.of(context).size.width;
    return Container(
      width: width,
      child: HtmlParser(
