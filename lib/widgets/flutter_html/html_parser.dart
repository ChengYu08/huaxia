...
import 'package:huaxia/widgets/custom_selectable_text/src/custom_selectable_text.dart';
import 'package:huaxia/widgets/flutter_html/flutter_html.dart';
import 'package:huaxia/widgets/flutter_html/src/css_parser.dart';
...
class HtmlParser extends StatelessWidget {
  ...
  HtmlParser({
    ...
    this.scrollPhysics, this.items, this.onSingleTapUp, this.onSelectionChanged,
...
class StyledText extends StatelessWidget {
  ...
  const StyledText({
    ...
    this.items,
    this.selectionControls,
    this.scrollPhysics, this.onSingleTapUp, this.onSelectionChanged,
  }) : _selectable = false,
        super(key: key);
