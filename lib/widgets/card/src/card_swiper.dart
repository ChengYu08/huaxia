...
class CardSwiper extends StatefulWidget {
  ...
  final CardWidgetBuilder cardBuilder;
      ...
      child: GestureDetector(
        child: Transform.rotate(
          ...
          child: ConstrainedBox(
            ...
            child: widget.cardBuilder(context, _currentIndex!,true),
          ),
        ),
        onTap: () async {
        ...
        onPanUpdate: (tapInfo) {
          ...
          if(tapInfo.delta.dx>=0){
            widget.onLike?.call(1);
          }else{
            widget.onLike?.call(2);
          }

        },
        onPanEnd: (tapInfo) {
          widget.onLike?.call(0);
          if (_canSwipe) {
            _tappedOnTop = false;
            _onEndAnimation();
          }
  ...
  Widget _backItem(BoxConstraints constraints, int index) {
    return Positioned(
      ...
      child: Transform.scale(
        ...
        child: ConstrainedBox(
          constraints: constraints,
          child: widget.cardBuilder(context, getValidIndexOffset(index)!,false),
        ),
      ),
    );
  }
