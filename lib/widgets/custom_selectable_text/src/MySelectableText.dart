...
class _SelectableTextSelectionGestureDetectorBuilder extends TextSelectionGestureDetectorBuilder {
  ...
  void onSingleTapUp(TapDragUpDetails details) {
    ...
    _state.widget.onSingleTapUp?.call(details);
  }
...
class MySelectableText extends StatefulWidget {
  ...
  @override
  State<MySelectableText> createState() => _SelectableTextState();
...
class _SelectableTextState extends State<MySelectableText> implements TextSelectionGestureDetectorBuilderDelegate {
